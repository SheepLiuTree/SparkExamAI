...
Rectangle {
    ...
    Text {
        ...
        text: dbManager.getSetting("tuanwei_button4_text", "智能体")
        font.family: "阿里妈妈数黑体"
        font.pixelSize: 36
        color: "white"
        font.bold: true
    ...
    Text {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        text: "欢迎使用" + dbManager.getSetting("tuanwei_button4_text", "智能体") + "!"
        font.family: "阿里妈妈数黑体"
        font.pixelSize: 20
        color: "white"
    }
    ...
    Component.onCompleted: {
        console.log(dbManager.getSetting("tuanwei_button4_text", "智能体") + "页面加载")
        
        // 从数据库加载智能体地址设置
        var savedAgentAddress = dbManager.getSetting("ai_agent4_address", "https://www.coze.cn/s/hn97Tsa7-fw/")
