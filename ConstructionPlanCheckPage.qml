...
Rectangle {
    ...
    function showMessage(title, message) {
        var dialog = messageDialog.createObject(constructionPlanCheckPage, {
            "message": message
        })
        dialog.open()
    }
    ...
    Rectangle {
        ...
        Row {
            ...
            Rectangle {
                ...
                height: 40
                radius: 15
                color: !constructionPlanCheckPage.isLoggedIn ? "#CCCCCC" : (mouseArea1.pressed ? "#4a90e2" : "#2196F3")
                opacity: !constructionPlanCheckPage.isLoggedIn ? 0.7 : 1.0
                ...
                MouseArea {
                    id: mouseArea1
                    anchors.fill: parent
                    enabled: constructionPlanCheckPage.isLoggedIn
                    onClicked: { /* TODO: 施工计划获取逻辑 */ }
                }
            }
            ...
            Rectangle {
                ...
                height: 40
                radius: 15
                color: !constructionPlanCheckPage.isLoggedIn ? "#CCCCCC" : (mouseArea2.pressed ? "#4a90e2" : "#2196F3")
                opacity: !constructionPlanCheckPage.isLoggedIn ? 0.7 : 1.0
        ...
        Rectangle {
            ...
            Text {
                id: loginButtonText
                anchors.centerIn: parent
                text: constructionPlanCheckPage.isLoggedIn ? "已登录" : "登录"
                font.family: "阿里妈妈数黑体"
                font.pixelSize: 18
                color: "white"
            }
            ...
            MouseArea {
                ...
                anchors.fill: parent
                onClicked: { 
                    if (!constructionPlanCheckPage.isLoggedIn) {
        ...
        Row {
            ...
            Rectangle {
                ...
                height: 40
                radius: 15
                color: !constructionPlanCheckPage.isLoggedIn ? "#CCCCCC" : (mouseArea3.pressed ? "#4a90e2" : "#2196F3")
                opacity: !constructionPlanCheckPage.isLoggedIn ? 0.7 : 1.0
            ...
            Rectangle {
                ...
                height: 40
                radius: 15
                color: !constructionPlanCheckPage.isLoggedIn ? "#CCCCCC" : (mouseArea4.pressed ? "#4a90e2" : "#2196F3")
                opacity: !constructionPlanCheckPage.isLoggedIn ? 0.7 : 1.0
